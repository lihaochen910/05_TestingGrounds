...
void AS05_TestingGroundsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AS05_TestingGroundsCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AS05_TestingGroundsCharacter::TouchStopped);
...
void AS05_TestingGroundsCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AS05_TestingGroundsCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
